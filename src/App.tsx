...
const Slide = ({ children, active }: { children: React.ReactNode; active: boolean }) => (
  <div className={`transition-all duration-500 absolute inset-0 flex flex-col items-center p-4 md:p-8 ${active ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full pointer-events-none'}`}>
    {/* Container dengan overflow-y-auto agar tidak terpotong di HP */}
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-4 md:gap-6 p-4 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-slate-500 leading-tight md:leading-normal">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      content: (
        <div className="w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-5 bg-slate-50 rounded-2xl border border-slate-200">
              <h3 className="font-bold text-lg mb-2 text-emerald-600 italic">Lokal Platform</h3>
              <ul className="text-xs md:text-sm space-y-1 text-slate-600">
            ...
            <div className="p-5 bg-blue-600 rounded-2xl text-white shadow-xl">
              <h3 className="font-bold text-lg mb-2">Aethra Donasi</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            <div className="space-y-4 md:space-y-6">
              {[
                ...
                { t: "Campaign Discovery", d: "Filter kategori & Lokasi." }
              ].map((f, i) => (
            ...
            <div className="space-y-4 md:space-y-6">
              {[
                ...
                { t: "Impact Reports", d: "Update foto & video." }
              ].map((f, i) => (
                <div key={i} className="flex gap-3">
                  <div className="bg-blue-100 p-2 h-fit rounded-lg shrink-0"><CheckCircle2 className="text-blue-600 w-4 h-4 md:w-5 md:h-5" /></div>
                  <div>
    ...
    // SLIDE 6: USP
    {
      content: (
        <div className="w-full max-w-4xl text-center">
          ...
          <p className="text-xs md:text-sm text-slate-500 mb-8 md:mb-12">Keunggulan Utama Platform Kami</p>
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12">
            <div className="flex flex-col items-center">
              ...
              <p className="text-[10px] md:text-xs text-slate-400">Buku kas terbuka</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[10px] md:text-xs text-slate-400">Arsip nota digital</p>
            </div>
          </div>
        </div>
      )
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="flex flex-col md:flex-row gap-4 relative">
            ...
            {[
              ...
              <div key={i} className="flex md:flex-col items-start md:items-center gap-4 md:gap-0 z-10 w-full">
  ...
  return (
    <div className="fixed inset-0 bg-slate-50 font-sans text-slate-900 flex flex-col overflow-hidden">
      ...
      <div className="p-4 md:p-8 flex justify-between items-center bg-white border-t border-slate-100 z-50">
        ...
        <button 
          onClick={nextSlide}
          className="flex items-center gap-1 md:gap-2 px-6 md:px-8 py-2 md:py-3 rounded-xl bg-blue-600 text-white text-xs md:text-sm font-bold hover:bg-blue-700 shadow-lg"
        >
